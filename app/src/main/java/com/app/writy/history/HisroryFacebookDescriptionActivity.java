...
import com.app.writy.YouTubTitleActivity;
import com.app.writy.ads.AdMob;
import com.app.writy.ads.OnDismiss;
import com.app.writy.databinding.ActivityHisroryFacebookDescriptionBinding;
...
public class HisroryFacebookDescriptionActivity extends AppCompatActivity {

    ActivityHisroryFacebookDescriptionBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHisroryFacebookDescriptionBinding.inflate(getLayoutInflater());
        ...
        for (int i = 0; i < Type.size(); i++) {
            if (Type.get(i).category.equals("facebookdescription")){
                data.add(Type.get(i));
            }
        }
        ...
        Dialog coin = new Dialog(HisroryFacebookDescriptionActivity.this);
        ...
        delet.setOnClickListener(view -> {
            for (int i = 0; i < selectedimagepaths.size(); i++) {
                ...
                Toast.makeText(HisroryFacebookDescriptionActivity.this, "deleted", Toast.LENGTH_SHORT).show();
                finish();
    ...
    public class historyAdapter extends RecyclerView.Adapter<historyAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull historyAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            holder.move.setOnClickListener(view -> {
                Intent i = new Intent(HisroryFacebookDescriptionActivity.this, ResultActivity.class);
    ...
    public void onBackPressed() {
        new AdMob(new OnDismiss() {
            ...
            public void onDismiss() {
                if (save == 1){
                    startActivity(new Intent(HisroryFacebookDescriptionActivity.this, StartMenuActivity.class));
                    finish();
                }else {
                    startActivity(new Intent(HisroryFacebookDescriptionActivity.this, HistoryMenuActivity.class));
                    finish();
                }
            }
        }).showAds2(HisroryFacebookDescriptionActivity.this, true);
