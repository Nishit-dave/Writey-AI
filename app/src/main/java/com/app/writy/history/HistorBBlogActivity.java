...
import com.app.writy.databinding.ActivityHistorBblogBinding;
...
public class HistorBBlogActivity extends AppCompatActivity {

    ActivityHistorBblogBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHistorBblogBinding.inflate(getLayoutInflater());
        ...
        for (int i = 0; i < Type.size(); i++) {
            if (Type.get(i).category.equals("BBlog")){
                data.add(Type.get(i));
            }
        }
        ...
        Dialog coin = new Dialog(HistorBBlogActivity.this);
        ...
        delet.setOnClickListener(view -> {
            for (int i = 0; i < selectedimagepaths.size(); i++) {
                ...
                Toast.makeText(HistorBBlogActivity.this, "deleted", Toast.LENGTH_SHORT).show();
                finish();
    ...
    public class historyAdapter extends RecyclerView.Adapter<historyAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull historyAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            holder.move.setOnClickListener(view -> {
                Intent i = new Intent(HistorBBlogActivity.this, ResultActivity.class);
    ...
    public void onBackPressed() {
        new AdMob(new OnDismiss() {
            ...
            public void onDismiss() {
                if (save == 1){
                    startActivity(new Intent(HistorBBlogActivity.this, StartMenuActivity.class));
                    finish();
                }else {
                    startActivity(new Intent(HistorBBlogActivity.this, HistoryMenuActivity.class));
                    finish();
                }
            }
        }).showAds2(HistorBBlogActivity.this, true);
