...
import com.app.writy.databinding.ActivityHistoryInstaCaptionBinding;
...
public class HistoryInstaCaptionActivity extends AppCompatActivity {

    ActivityHistoryInstaCaptionBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHistoryInstaCaptionBinding.inflate(getLayoutInflater());
        ...
        for (int i = 0; i < Type.size(); i++) {
            if (Type.get(i).category.equals("InstaCaption")){
                data.add(Type.get(i));
            }
        }
        ...
        Dialog coin = new Dialog(HistoryInstaCaptionActivity.this);
        ...
        delet.setOnClickListener(view -> {
            for (int i = 0; i < selectedimagepaths.size(); i++) {
                ...
                Toast.makeText(HistoryInstaCaptionActivity.this, "deleted", Toast.LENGTH_SHORT).show();
                finish();
    ...
    public class historyAdapter extends RecyclerView.Adapter<historyAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull historyAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            holder.move.setOnClickListener(view -> {
                Intent i = new Intent(HistoryInstaCaptionActivity.this, ResultActivity.class);
    ...
    public void onBackPressed() {
        new AdMob(new OnDismiss() {
            ...
            public void onDismiss() {
                if (save == 1){
                    startActivity(new Intent(HistoryInstaCaptionActivity.this, StartMenuActivity.class));
                    finish();
                }else {
                    startActivity(new Intent(HistoryInstaCaptionActivity.this, HistoryMenuActivity.class));
                    finish();
                }
            }
        }).showAds2(HistoryInstaCaptionActivity.this, true);
