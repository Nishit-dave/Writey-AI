...
import com.app.writy.databinding.ActivityHistoryLinkDinDescriptionBinding;
...
public class HistoryLinkDinDescriptionActivity extends AppCompatActivity {

    ActivityHistoryLinkDinDescriptionBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHistoryLinkDinDescriptionBinding.inflate(getLayoutInflater());
        ...
        for (int i = 0; i < Type.size(); i++) {
            if (Type.get(i).category.equals("LinkeDin")){
                data.add(Type.get(i));
            }
        }
        ...
        Dialog coin = new Dialog(HistoryLinkDinDescriptionActivity.this);
        ...
        delet.setOnClickListener(view -> {
            for (int i = 0; i < selectedimagepaths.size(); i++) {
                ...
                Toast.makeText(HistoryLinkDinDescriptionActivity.this, "deleted", Toast.LENGTH_SHORT).show();
                finish();
    ...
    public class historyAdapter extends RecyclerView.Adapter<historyAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull historyAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            holder.move.setOnClickListener(view -> {
                Intent i = new Intent(HistoryLinkDinDescriptionActivity.this, ResultActivity.class);
    ...
    public void onBackPressed() {
        new AdMob(new OnDismiss() {
            ...
            public void onDismiss() {
                if (save == 1){
                    startActivity(new Intent(HistoryLinkDinDescriptionActivity.this, StartMenuActivity.class));
                    finish();
                }else {
                    startActivity(new Intent(HistoryLinkDinDescriptionActivity.this, HistoryMenuActivity.class));
                    finish();
                }
            }
        }).showAds2(HistoryLinkDinDescriptionActivity.this, true);
