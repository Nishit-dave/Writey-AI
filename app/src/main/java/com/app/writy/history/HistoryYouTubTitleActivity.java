...
import com.app.writy.databinding.ActivityHistoryYouTubTitleBinding;
...
public class HistoryYouTubTitleActivity extends AppCompatActivity {

    ActivityHistoryYouTubTitleBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHistoryYouTubTitleBinding.inflate(getLayoutInflater());
        ...
        for (int i = 0; i < Type.size(); i++) {
            if (Type.get(i).category.equals("youtubtitle")){
                data.add(Type.get(i));
            }
        }
        ...
        Dialog coin = new Dialog(HistoryYouTubTitleActivity.this);
        ...
        delet.setOnClickListener(view -> {
            for (int i = 0; i < selectedimagepaths.size(); i++) {
                ...
                Toast.makeText(HistoryYouTubTitleActivity.this, "deleted", Toast.LENGTH_SHORT).show();
                finish();
    ...
    public class historyAdapter extends RecyclerView.Adapter<historyAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull historyAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            holder.move.setOnClickListener(view -> {
                Intent i = new Intent(HistoryYouTubTitleActivity.this, ResultActivity.class);
    ...
    public void onBackPressed() {
        new AdMob(new OnDismiss() {
            ...
            public void onDismiss() {
                if (save == 1){
                    startActivity(new Intent(HistoryYouTubTitleActivity.this, StartMenuActivity.class));
                    finish();
                }else {
                    startActivity(new Intent(HistoryYouTubTitleActivity.this, HistoryMenuActivity.class));
                    finish();
                }
            }
        }).showAds2(HistoryYouTubTitleActivity.this, true);
