...
import com.app.writy.databinding.ActivityHistoryYouTubeDescriptionBinding;
...
public class HistoryYouTubeDescriptionActivity extends AppCompatActivity {

    ActivityHistoryYouTubeDescriptionBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHistoryYouTubeDescriptionBinding.inflate(getLayoutInflater());
        ...
        for (int i = 0; i < Type.size(); i++) {
            if (Type.get(i).category.equals("youtubdescription")){
                data.add(Type.get(i));
            }
        }
        ...
        Dialog coin = new Dialog(HistoryYouTubeDescriptionActivity.this);
        ...
        delet.setOnClickListener(view -> {
            for (int i = 0; i < selectedimagepaths.size(); i++) {
                ...
                Toast.makeText(HistoryYouTubeDescriptionActivity.this, "deleted", Toast.LENGTH_SHORT).show();
                finish();
    ...
    public class historyAdapter extends RecyclerView.Adapter<historyAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull historyAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            holder.move.setOnClickListener(view -> {
                Intent i = new Intent(HistoryYouTubeDescriptionActivity.this, ResultActivity.class);
    ...
    public void onBackPressed() {
        new AdMob(new OnDismiss() {
            ...
            public void onDismiss() {
                if (save == 1){
                    startActivity(new Intent(HistoryYouTubeDescriptionActivity.this, StartMenuActivity.class));
                    finish();
                }else {
                    startActivity(new Intent(HistoryYouTubeDescriptionActivity.this, HistoryMenuActivity.class));
                    finish();
                }
            }
        }).showAds2(HistoryYouTubeDescriptionActivity.this, true);
